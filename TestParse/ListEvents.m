         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.whereWhenLabel.text = [NSString stringWithFormat:@"%@ à %@", [formatterHourMinute stringFromDate:start_date], event[@"location"]];
    cell.ownerInvitation.text = [NSString stringWithFormat:@"%@ vous a envoyé une invitation.", event[@"owner"][@"name"]];
